...
function roster() {
    ...
    this.sex = "女";
    this.email = "";
    this.photo = mydomain + "/bundles/fafatimewebase/images/no_photo.png";
    ...
    this.GetJid = function(_resource) {
        ...
        if (typeof(this.resource) != "string") {
            if (this.resource.join(",").indexOf("FaFaWin") > -1)
                return this.jid + "/FaFaWin";
            else if (this.resource.join(",").indexOf("FaFaAndroid") > -1)
                return this.jid + "/FaFaAndroid";
            else if (this.resource.join(",").indexOf("FaFaIPhone") > -1)
                return this.jid + "/FaFaIPhone";
            else if (this.resource.join(",").indexOf("iPad") > -1)
                return this.jid + "/iPad";
            else if (this.resource.join(",").indexOf("FaFaWeb") > -1)
                return this.jid + "/FaFaWeb";
        }
        ...
        try {
            ...
            if (FaFaMessage.isAttached) {
                var iq = $iq({
                    ...
                    xmlns: 'http://im.fafacn.com/namespace/userstate'
                }).tree();
                ...
                if (FaFaMessage._rlist.length > 0) {
                    ...
                    if (sendSub) {
                        ...
                        var reply = $iq({
                            ...
                            xmlns: 'http://im.fafacn.com/namespace/subscribe'
                        });
    ...
    */
    ...
    SendGroupMessage: function(From, To, Msg, Nick) {
        ...
        var reply = $iq({
            ...
            .c('groupchat', {
                xmlns: 'http://im.fafacn.com/namespace/group',
                groupid: To,
    ...
    SendOfflineFileRequest: function(From, To, fn, fnID, Nick) {
        ...
        var reply = $iq({
            ...
            xmlns: 'http://im.fafacn.com/namespace/offlinefile',
            filehashvalue: fnID,
    ...
    SendFileRequest: function(From, To, fn, fnID, Nick) {
        ...
        var reply = $iq({
            ...
            xmlns: 'http://im.fafacn.com/namespace/employee',
            fileid: fnID,
            fileName: FaFaMessage.fomratString(fn),
            action: "request",
            sendtime: hour + ":" + minute + ":" + second,
    ...
    $.getJSON(mydomain + "/api/baseinfo/getstaffcard?jsoncallback=?",parainfo, function(data) {
        ...
        if (data.returncode != "9999") {
            ...
            if (data.staff_full.photo_path != null && data.staff_full.photo_path != "")
                rosterInfo.photo = mydomain + "/getfile/image/middle/" + data.staff_full.photo_path;
        } else {
...
//   <querygroup xmlns='http://im.fafacn.com/namespace/group' ver='xxx'>
//   </querygroup>
// </iq>
    ...
    $.getJSON(mydomain + "/api/http/getgroupinfo?jsoncallback=?", parainfo, function(data) {
        ...
        if (data.returncode == "0000" && data.group != null && data.group.groupid != null) {
            ...
            if (data.group.groupclass == "circlegroup" && data.group.logo == "")
                ...
                data.group.logo = mydomain + "/getfile/" + data.group.logo;
            func(data.group);
            return;
        }
        data.group.logo = mydomain + "/bundles/fafatimewebase/images/default_group.png";
    ...
    GetDept: function(Deptid, func) {
        if (Deptid == null) {
            ...
            var iq = $iq({
                ...
                xmlns: 'http://im.fafacn.com/namespace/dept',
