...
use Justsy\BaseBundle\weibo\OAuthException;
...
class SaeTOAuthV2 {
	...
	public static $appid='3453861999';
	public static $appkey='43bb4bfb105424e7f6a9a465c653cb7d';
	...
	function getError($re){
		if(isset($re['error_code'])){
			return array('code'=> $re['error_code'],'desc'=> $re['error']);
		}
		else{
			return null;
		}
