...
$logger = new Logger('wefafa_remind_minute');
$logger->pushHandler(new StreamHandler(__DIR__.'/wefafa_remind_minute.log', Logger::DEBUG));
...
while(true)
{
  ...
  //具体年或时段年
  $condition .= " and year='-1' and month='-1' and day='-1' and hour='-1'";
   ...
   //发送邮件
    ...
    if ($to_mobile !=null && !empty($to_mobile))
    {
    	if ($content != null || !empty($content))
    	  call_user_func("sendMobile",$SMS_ACT,$SMS_PWD,$SMS_URL,$to_mobile,$content."【Wefafa企业协作平台】");
    }
    //发送wefafa消息
