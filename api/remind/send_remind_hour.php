...
$logger = new Logger('wefafa_remind_hour');
$logger->pushHandler(new StreamHandler(__DIR__.'/wefafa_remind_hour.log', Logger::DEBUG));
...
while(true)
{
  ...
  //具体年或时段年
  $condition .= " and year='-1' and month='-1' and day='-1' and position(case when hour(now())<10 then concat('0',hour(now())) else hour(now()) end in hour)>0";  
