...
$logger = new Logger('wefafa_remind_year');
$logger->pushHandler(new StreamHandler(__DIR__.'/wefafa_remind_year.log', Logger::DEBUG));
...
while(true)
{
  ...
  //具体年或时段年
  $condition .= " and position(year(curdate()) in year)>0";
