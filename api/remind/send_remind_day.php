...
$logger = new Logger('wefafa_remind_day');
$logger->pushHandler(new StreamHandler(__DIR__.'/wefafa_remind_day.log', Logger::DEBUG));
...
while(true)
{
  ...
  //具体天数天
  $condition .= " and year='-1' and month='-1' and position(case when day(curdate())<10 then concat('0',day(curdate())) else day(curdate()) end in day)>0";  
