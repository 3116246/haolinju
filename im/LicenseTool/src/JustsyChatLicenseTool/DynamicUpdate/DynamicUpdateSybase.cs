...
/// <summary>
/// DynamicUpdateSybase 的摘要说明
/// 
/// 非线程安全类
/// </summary>
namespace DynamicUpdate
{
    public class DynamicUpdateSybase : DynamicUpdate
    {
        ...
        public DynamicUpdateSybase()
            : this(DynamicUpdate.ConnStr)
        {
        }

        public DynamicUpdateSybase(string ConnString)
        {
        ...
        override public System.Data.DataSet GetDatas(string[] MappingTables, string[] SQLs, object[][] ParaValues)
        {
            ...
            for (int i = 0; i < ParaValues.Length; i++)
            {
                ...
                {
                    ParaTypes[i][j] = (System.Data.OleDb.OleDbType)DynamicUpdateSybase.htDataType[ParaValues[i][j] == null ? typeof(string) : ParaValues[i][j].GetType()];
                }
            }
        ...
        protected System.Data.DataTable Update(System.Data.DataTable xdt, string SourceTable, System.Data.OleDb.OleDbTransaction odTrans)
        {
            try
            {
                ...
                odCommSelect = new System.Data.OleDb.OleDbCommand("select type, name,(case isnull(prec, 0) when 0 then (case type when 34 then 2147483647 when 35 then 2147483647 when 50 then 0 when 61 then 0 when 111 then 0 else length end) else 0 end) as length,isnull(prec, 0) as prec ,isnull(scale,0) as scale from syscolumns where id=object_id('" + SourceTable + "')", odc);
                ...
                foreach (System.Data.DataColumn dc in xdt.Columns)
                {
                    ...
                    odCommInsert.Parameters.Add(new System.Data.OleDb.OleDbParameter(dc.ColumnName, (System.Data.OleDb.OleDbType)DynamicUpdateSybase.htDataType[dc.DataType], length, System.Data.ParameterDirection.Input, false, prec, scale, dc.ColumnName, System.Data.DataRowVersion.Current, null));
                    odCommUpdate.Parameters.Add(new System.Data.OleDb.OleDbParameter(dc.ColumnName, (System.Data.OleDb.OleDbType)DynamicUpdateSybase.htDataType[dc.DataType], length, System.Data.ParameterDirection.Input, false, prec, scale, dc.ColumnName, System.Data.DataRowVersion.Current, null));
                }
                ...
                if (xdt.PrimaryKey.Length == 0)
                {
                    foreach (System.Data.DataColumn dc in xdt.Columns)
                    {
                        ...
                        odCommUpdate.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_" + dc.ColumnName, (System.Data.OleDb.OleDbType)DynamicUpdateSybase.htDataType[dc.DataType], length, System.Data.ParameterDirection.Input, false, prec, scale, dc.ColumnName, System.Data.DataRowVersion.Original, null));
                        odCommDelete.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_" + dc.ColumnName, (System.Data.OleDb.OleDbType)DynamicUpdateSybase.htDataType[dc.DataType], length, System.Data.ParameterDirection.Input, false, prec, scale, dc.ColumnName, System.Data.DataRowVersion.Original, null));
                    }
                }
                else
                {
        ...
        {
            return (System.Data.OleDb.OleDbType)DynamicUpdateSybase.htDataType[AType];
        }
