...
-include ("../include/bson_binary.hrl").
...
-type bintype() :: bin | function | bin_old | uuid | md5 | userdefined.

-spec put_binary (bintype(), binary()) -> binary().
put_binary (BinType, Bin) ->
	Tag = case BinType of bin -> 0; function -> 1; bin_old -> 2; uuid -> 3; md5 -> 5; userdefined -> 128 end,
...
get_binary (<<?get_int32 (Size), Tag:8, Bin /binary>>) ->
	BinType = case Tag of 0 -> bin; 1 -> function; 2 -> bin_old; 3 -> uuid; 5 -> md5; 128 -> userdefined end,
