...
-export([sql_add_privacy_list/3,
         sql_get_default_privacy_list/2,
         sql_get_default_privacy_list_t/2,
         sql_get_privacy_list_data/3,
         sql_get_privacy_list_data_by_id_t/1,
         sql_get_privacy_list_id_t/3,
         sql_set_default_privacy_list/3,
...
%		case sql_get_privacy_list_names_t(LUser) of
		case sql_get_privacy_list_names_t(LServer, LUser) of
		    {selected, ["name"], []} ->
			{error, ?ERR_ITEM_NOT_FOUND};
		    {selected, ["name"], Names} ->
...
%				sql_set_default_privacy_list(LUser, Name),
				sql_set_default_privacy_list(LServer, LUser, Name),
				{result, []};
			    false ->
				{error, ?ERR_ITEM_NOT_FOUND}
			end
...
%			case sql_get_default_privacy_list_t(LUser) of
			case sql_get_default_privacy_list_t(LServer, LUser) of
			    {selected, ["name"], []} ->
%				sql_remove_privacy_list(LUser, Name),
				sql_remove_privacy_list(LServer, LUser, Name),
				{result, []};
...
%			    case sql_get_privacy_list_id_t(LUser, Name) of
			    case sql_get_privacy_list_id_t(LServer, LUser, Name) of
				{selected, ["id"], []} ->
%				    sql_add_privacy_list(LUser, Name),
				    sql_add_privacy_list(LServer, LUser, Name),
				    {selected, ["id"], [{I}]} =
%					sql_get_privacy_list_id_t(LUser, Name),
					sql_get_privacy_list_id_t(LServer, LUser, Name),
				    I;
				{selected, ["id"], [{I}]} ->
				    I
			    end,
...
sql_get_default_privacy_list_t(LServer, LUser) ->
    Username = ejabberd_odbc:escape(LUser),
...
sql_get_privacy_list_names_t(LServer, LUser) ->
    Username = ejabberd_odbc:escape(LUser),
